public class Main {
    public static void main(String[] args) {
        ...
        */
        ...
        //System.out.println(new AddtoArrayFormofInteger_989().addToArrayForm(num2, 806));
        //System.out.println(new StringCompression_443().compress(num3));
